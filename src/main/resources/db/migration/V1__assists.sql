...
VALUES 
        ('Troca de aparelho', 'Troca de aparelho decodificador de sinal'),
        ('Troca de cabo interno', 'Troca de cabo interno'),
        ('Troca de fiação interna', 'Substituição de fiação interna da residência'),
        ('Manutenção em fogão', 'Reparo sem necessidade de compra de peças'),
        ('Manutenção em geladeira', 'Reparo sem necessidade de compra de peças'),
        ('Manutenção em máquina de lavar', 'Reparo sem necessidade de compra de peças'),
        ('Telefones', 'Instalação/Manutenção de sistemas de telefone'),
